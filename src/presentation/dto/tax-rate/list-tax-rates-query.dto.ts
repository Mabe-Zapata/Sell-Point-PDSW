...
/**
 * Query DTO for the `GET /tax-rates` endpoint.
 *
 ...
 * a request like `GET /tax-rates?page=1&limit=5&q=iva` was failing.
 *
 ...
 * `@Query() query: ListTaxRatesQueryDto` argument and reads each field
 * off the resulting DTO.
 */
export class ListTaxRatesQueryDto extends PaginationQueryDto {
  @ApiPropertyOptional({
    description: 'Free-text search across name and code',
    maxLength: 100,
    type: String,
  })
  @IsOptional()
